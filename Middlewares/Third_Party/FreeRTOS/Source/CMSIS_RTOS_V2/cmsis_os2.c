...
#define configTOTAL_HEAP_SIZE2 0x4000
static uint8_t ucHeap2[configTOTAL_HEAP_SIZE2];
static uint8_t ucHeap[configTOTAL_HEAP_SIZE] __attribute__((at(0x20000000)));
static HeapRegion_t xHeapRegions[] = {
    { ucHeap, configTOTAL_HEAP_SIZE },
    //    { ucHeap2, configTOTAL_HEAP_SIZE2},
    { NULL,   0                     }
};
#else
